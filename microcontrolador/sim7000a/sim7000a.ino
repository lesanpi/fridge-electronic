...
#define FONA_TX D10 // Microcontroller RX
#define FONA_RX D9  // Microcontroller TX
...
SoftwareSerial fonaSS = SoftwareSerial(FONA_TX, FONA_RX, false); // TX, RX, inverted logic, buffer size
...
// turn GPRS off first for SIM7500/7600
  ...
  case '2':
  {
    ...
    if (!fona.getBattVoltage(&battLevel))
      battLevel = 3800; // Use dummy voltage if can't read
